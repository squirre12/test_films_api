...
class Film(db.Model):
    ...
    def __repr__(self):
        return f'Film({self.title}, {self.release_date}, {self.uuid}, {self.distributed_by}, {self.actors}, {self.rating})'
...
class Actor(db.Model):
    ...
    def __repr__(self):
        return f'{self.name}, {self.birthday}, {self.contact}'
...
class User(db.Model):
    ...
    def find_user_by_username(cls, username):
        return cls.query.filter_by(username=username).firt()

    @classmethod
    def find_user_by_uuid(cls, uuid):
        return cls.query.filter_by(uuid=uuid).firt()